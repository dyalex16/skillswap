...
CREATE TABLE "UserWant" (
    ...
    CONSTRAINT "UserWant_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "UserWant_userId_skillId_key" ON "UserWant"("userId", "skillId");
...
-- AddForeignKey
ALTER TABLE "UserWant" ADD CONSTRAINT "UserWant_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "UserWant" ADD CONSTRAINT "UserWant_skillId_fkey" FOREIGN KEY ("skillId") REFERENCES "Skill"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
